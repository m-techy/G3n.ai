...
const Header = () => {
  ...
  return (
    <div className="w-full h-[10vh] py-4 flex justify-between items-center fixed top-0 z-50 backdrop-blur-sm px-[10%]">
      <div className="logo w-[6.5rem] cursor-pointer">
        <Link to="/">
          <img src={logo} alt="logo" />
        </Link>
      ...
      <div
        className={`${
          isOpen ? "flex" : "hidden"
        } sm:items-end absolute top-[10vh] left-0 w-[85%] sm:backdrop-blur-sm  flex-col md:flex md:static md:bg-transparent md:w-auto md:flex-row md:items-center md:gap-8 text-[14.5px] font-semibold lg:flex lg:static lg:bg-transparent lg:w-auto lg:flex-row lg:items-center lg:gap-8 xl:flex xl:static xl:bg-transparent xl:w-auto xl:flex-row xl:items-center xl:gap-8 2xl:flex 2xl:static 2xl:bg-transparent 2xl:w-auto 2xl:flex-row 2xl:items-center 2xl:gap-8`}
      >
        ...
        <a
          ...
          className="sm:visible md:hidden xl:hidden lg:hidden 2xl:hidden"
        >
          <div className="navhover cursor-pointer md:hidden hover:">
            <a
              href="https://github.com/m-techy/G3n.ai"
              target="_blank"
